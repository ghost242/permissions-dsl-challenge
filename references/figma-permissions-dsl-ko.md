...
1. **Keeping Figma fast** (2023년 8월 29일) - Slava Kim, Laurel Woods
   - 빈 사무실에서 노트북이 충돌했을 때, 성능 테스트 프레임워크를 전면 개편할 때라는 것을 알았습니다.

2. **How Figma's multiplayer technology works** (2019년 10월 16일) - Evan Wallace
   - 라이브 협업 편집 기능을 갖춘 최초의 디자인 도구로서 구축한 자체 솔루션을 살펴봅니다.

3. **Enforcing device trust on code changes** (2023년 12월 8일) - Griffin Choe
   - Figma 보안 엔지니어링 팀이 커밋 서명과 Okta Device Trust 인증서를 활용하여 GitHub 릴리스 브랜치를 보호한 방법입니다.

---

**이러한 유형의 작업에 관심이 있다면 채용 공고를 확인하세요—[채용 중](https://www.figma.com/careers/)입니다!**
